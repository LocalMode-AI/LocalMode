/**
 * @file ui.tsx
 * @description Reusable UI components for the duplicate-finder application
 */
...
interface BadgeProps extends HTMLAttributes<HTMLDivElement> {
  /** Badge style variant */
  variant?: 'primary' | 'ghost' | 'success' | 'warning' | 'error';
  /** Badge size */
  size?: 'sm' | 'md';
}
...
const ICONBOX_VARIANTS = {
  ...
  accent: 'bg-poster-accent-orange text-white',
} as const;
...
const DOT_COLORS = {
  orange: 'bg-poster-accent-orange',
  primary: 'bg-poster-primary',
  error: 'bg-error',
} as const;

/** Pulsing status indicator dot */
export function StatusDot({ color = 'orange', pulse = true, size = 'sm' }: StatusDotProps) {
