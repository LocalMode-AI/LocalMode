...
| MediaPipe Studio | Real-time hand/pose/face/gesture tracking | [Demo](https://localmode.ai/mediapipe-studio) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/showcase-nextjs/src/app/(apps)/mediapipe-studio) |
