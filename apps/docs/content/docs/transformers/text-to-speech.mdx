...
<Callout type="info" title="See it in action">
  Try the [Audio Studio block](https://localmode.ai/blocks/audio) — it streams long-form Kokoro TTS and lets you browse and compare all 29 English voices.
</Callout>
...
<Callout type="tip" title="TTS Tips">
  ...
  2. **Pick the right voice** — Browse all 29 in the [Audio Studio block](https://localmode.ai/blocks/audio)
...
|-----|-------------|-------|
| Audiobook Reader | Long-text streaming Kokoro synthesis with early playback, speed control, transport, and WAV download | [Live](https://localmode.ai/blocks/audio/audiobook-reader) · Install: `npx shadcn add @localmode/ui/blocks/audio/audiobook-reader` |
