...
<Callout type="info" title="See it in action">
  Try the [Translator block](https://localmode.ai/blocks/writing-tools/translate) — it
  runs offline Opus-MT translation live in the browser.
</Callout>
...
Based on the [Translator block](https://localmode.ai/blocks/writing-tools/translate) — use a different model per language pair:
...
|-----|-------------|-------|
| Translator | Offline Opus-MT translation across language pairs | [Live](https://localmode.ai/blocks/writing-tools/translate) · Install: `npx shadcn add @localmode/ui/blocks/writing-tools/translate` |
