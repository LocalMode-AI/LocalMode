...
<Callout type="info" title="See it in action">
  Try the [Knowledge Base block](https://localmode.ai/blocks/knowledge/document-qa) — it ingests
  documents and answers questions about them, grounded and on-device.
</Callout>
