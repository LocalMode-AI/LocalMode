...
<Callout type="info" title="See it in action">
  Try the [Audio Studio block](https://localmode.ai/blocks/audio) — it records and
  transcribes audio with Whisper, then summarizes it, entirely in the browser.
</Callout>
...
Based on the [Audio Studio block](https://localmode.ai/blocks/audio):
...
|-----|-------------|-------|
| Voice Notes | Record or upload audio → Whisper/Moonshine transcription → saved notes with word-by-word replay and semantic search | [Live](https://localmode.ai/blocks/audio/voice-notes) · Install: `npx shadcn add @localmode/ui/blocks/audio/voice-notes` |
