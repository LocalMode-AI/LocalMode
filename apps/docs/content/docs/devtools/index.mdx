...
|-----|-------------|-------|
| LocalMode Showcase | DevTools widget enabled globally across all 34 showcase apps | [Demo](https://localmode.ai) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/showcase-nextjs/src/app/_components/devtools.tsx) |
