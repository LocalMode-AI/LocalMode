...
<Callout type="info" title="See it in action">
  Switch the [Knowledge Base block](https://localmode.ai/blocks/knowledge/rag-chat) to its LangChain engine — grounded answers there stream through `ChatLocalMode`, live in the browser.
</Callout>
