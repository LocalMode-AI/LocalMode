...
|-----|-------------|-------|
| Live Tracker | Real-time MediaPipe hand, pose, face, and gesture tracking | [Live](https://localmode.ai/blocks/vision/live-tracker) · Install: `npx shadcn add @localmode/ui/blocks/vision/live-tracker` |
