...
| `Qwen3.5-4B-q4f16_1-MLC`                    | ~2.39GB | 32K     | Qwen 3.5 4B, latest multilingual, 32K context |
| `Qwen3.5-9B-q4f16_1-MLC`                    | ~5.06GB | 32K     | Qwen 3.5 9B, highest-quality preset (8GB+ RAM) |
...
<Callout type="info" title="Model Selection Guide">
  ...
  - **Multilingual**: `Qwen3-1.7B`, `Qwen3-8B`, or `Qwen3.5-4B` (32K context) — latest generation, 100+ languages
  - **High-Quality 32K Context**: `Qwen3.5-4B` (~2.39GB) or `Qwen3.5-9B` (~5.06GB, 8GB+ RAM)
...
| Chrome 113+ | ✅                |
| Edge 113+   | ✅                |
| Firefox 141+ | ✅ (Win) / Firefox 147+ on macOS Apple Silicon |
| Safari 26+  | ✅                |
| iOS Safari  | ✅ (iOS 26+)      |
