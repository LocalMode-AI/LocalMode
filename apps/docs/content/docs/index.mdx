---
title: Introduction
description: Local-first, privacy-first, offline-first AI for the browser. 15 packages. 34 demo apps. Zero cloud dependencies.
icon: House
---
...
<Cards>
  ...
  <Card
    ...
    href="/docs/react"
    description="56 React hooks for all core functions — useChat, useEmbed, useClassify, useTranscribe, and more with built-in loading, error handling, and cancellation."
  />
</Cards>
...
<Cards>
  ...
  <Card
    title="React Hooks"
    href="/docs/react"
    description="56 hooks for chat, embeddings, classification, vision, audio, and more."
  />
  <Card
