...
### `WLLAMA_MODELS` Catalog (18 Models)

The curated catalog ships 18 Q4_K_M quantized models across four size tiers (including two vision-language models):
...
| Models         | 160K+ GGUF models        | 32 curated MLC models    |
