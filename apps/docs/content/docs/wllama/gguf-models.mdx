...
|-----|-------------|-------|
| GGUF Explorer | Browse 160K+ GGUF models with metadata inspection and chat | [Demo](https://localmode.ai/gguf-explorer) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/showcase-nextjs/src/app/(apps)/gguf-explorer) |
