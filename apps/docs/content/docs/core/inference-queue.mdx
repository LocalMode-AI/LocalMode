...
<Callout type="info" title="See it in action">
  Try the [Knowledge Base block](https://localmode.ai/blocks/knowledge) for a working demo of these APIs.
</Callout>
...
|-----|-------------|-------|
| Knowledge Base (PDF Search) | Priority queue for embedding and search operations | [Live block](https://localmode.ai/blocks/knowledge/semantic-search) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/knowledge/semantic-search) |
