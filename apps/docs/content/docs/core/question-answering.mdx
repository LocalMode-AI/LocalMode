...
|-----|-------------|-------|
| Knowledge Base (QA Bot) | Answer questions from provided context | [Live block](https://localmode.ai/blocks/knowledge/document-qa) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/knowledge/document-qa) |
