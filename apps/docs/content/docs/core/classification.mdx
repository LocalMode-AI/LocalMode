...
<Callout type="info" title="See it in action">
  Try the [Text Insights blocks](https://localmode.ai/blocks/text-insights) for working demos of these APIs — the [Sentiment Analyzer](https://localmode.ai/blocks/text-insights/sentiment-analyzer) runs sentiment classification and the [Text Classifier](https://localmode.ai/blocks/text-insights/text-classifier) runs custom-label zero-shot email/intent routing, all on-device.
</Callout>
...
|-----|-------------|-------|
| Text Insights (Sentiment Analyzer) | Classify text sentiment with sequential batch processing | [Live block](https://localmode.ai/blocks/text-insights/sentiment-analyzer) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/text-insights/sentiment-analyzer) |
| Text Insights (Email Classifier) | Zero-shot email categorization into custom labels | [Live block](https://localmode.ai/blocks/text-insights/text-classifier) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/text-insights/text-classifier) |
