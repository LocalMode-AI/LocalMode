...
<Callout type="info" title="See it in action">
  Try the [Chat block](https://localmode.ai/blocks/chat) for a working demo of these APIs.
</Callout>
...
|-----|-------------|-------|
| Chat (LLM Chat) | Global event bus for model download and inference events | [Live block](https://localmode.ai/blocks/chat) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/chat) |
