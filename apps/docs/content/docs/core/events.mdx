...
<Callout type="info" title="See it in action">
  Try [LLM Chat](https://localmode.ai/llm-chat) for a working demo of these APIs.
</Callout>
...
|-----|-------------|-------|
| LLM Chat | Global event bus for model download and inference events | [Demo](https://localmode.ai/llm-chat) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/showcase-nextjs/src/app/(apps)/llm-chat) |
