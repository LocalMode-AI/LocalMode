...
<Callout type="info" title="See it in action">
  Try the [Knowledge Base block](https://localmode.ai/blocks/knowledge/document-qa) for a working demo of these APIs.
</Callout>
...
|-----|-------------|-------|
| Knowledge Base (Invoice QA) | Ask questions about document images | [Live block](https://localmode.ai/blocks/knowledge/document-qa) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/knowledge/document-qa) |
