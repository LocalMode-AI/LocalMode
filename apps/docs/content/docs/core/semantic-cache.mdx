...
<Callout type="info" title="See it in action">
  Try the [Knowledge Base block](https://localmode.ai/blocks/knowledge/rag-chat) and [Chat block](https://localmode.ai/blocks/chat) for working demos of these APIs.
</Callout>
...
|-----|-------------|-------|
| Knowledge Base (PDF Search) | Cache repeated PDF queries for faster responses | [Live block](https://localmode.ai/blocks/knowledge/rag-chat) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/knowledge/rag-chat) |
| Chat (LLM Chat) | Semantic caching for LLM conversation responses | [Live block](https://localmode.ai/blocks/chat) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/chat) |
