...
<Callout type="info" title="See it in action">
  Try the [Vision block](https://localmode.ai/blocks/vision) and [Image Studio block](https://localmode.ai/blocks/image-studio) for working demos of these APIs.
</Callout>
...
<Callout type="info" title="Landmark & gesture detection">
  `detectHands()`, `detectPose()`, `detectFace()`, `detectFaceLandmarks()`, and
  `recognizeGesture()` are implemented by the [`@localmode/mediapipe`](/docs/mediapipe)
  provider. For real-time 30-60fps video tracking, model recommendations, and
  practical recipes, see the [MediaPipe provider guide](/docs/mediapipe).
</Callout>
...
|-----|-------------|-------|
| Vision (Object Detector) | Detect and label objects in images | [Live block](https://localmode.ai/blocks/vision/object-detector) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/vision/object-detector) |
| Image Studio (Image Captioner) | Generate natural language image descriptions | [Live block](https://localmode.ai/blocks/image-studio/image-captioner) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/image-studio/image-captioner) |
| Image Studio (Background Remover) | Segment and remove image backgrounds | [Live block](https://localmode.ai/blocks/image-studio/background-remover) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/image-studio/background-remover) |
| Image Studio (Photo Enhancer) | Upscale and enhance photos with image-to-image models | [Live block](https://localmode.ai/blocks/image-studio/image-enhancer) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/image-studio/image-enhancer) |
| Photo Search (Duplicate Finder) | Extract image features for duplicate detection | [Live block](https://localmode.ai/blocks/photo/duplicate-finder) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/photo/duplicate-finder) |
| Photo Search (Smart Gallery) | Classify and organize photos by content | [Live block](https://localmode.ai/blocks/photo/smart-gallery) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/photo/smart-gallery) |
| Photo Search (Product Search) | Visual product classification and search | [Live block](https://localmode.ai/blocks/photo/image-search) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/photo/image-search) |
