...
<Callout type="info" title="See it in action">
  Try the [Complete block](https://localmode.ai/blocks/writing-tools/complete) for a working demo of these APIs.
</Callout>
...
|-----|-------------|-------|
| Writing Tools (Smart Autocomplete) | Predict masked words for text completion | [Live block](https://localmode.ai/blocks/writing-tools/complete) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/writing-tools/complete) |
