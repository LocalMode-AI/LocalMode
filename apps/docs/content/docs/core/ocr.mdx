...
<TypeTable
  type={{
    ...
    prompt: {
      description: 'Text prompt for generative OCR models (GLM-OCR, LightOnOCR-2). Controls the recognition mode: "Text Recognition:", "Table Recognition:", "Formula Recognition:". Ignored by non-generative models like TrOCR.',
      type: 'string',
      required: false,
    },
    abortSignal: {
...
|-----|-------------|-------|
| Knowledge Base (OCR Scanner) | Extract text from images and documents | [Live block](https://localmode.ai/blocks/knowledge/semantic-search) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/knowledge/semantic-search) |
