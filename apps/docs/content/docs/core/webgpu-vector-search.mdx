...
|-----|-------------|-------|
| Knowledge Base (PDF Search) | GPU-accelerated vector distance for PDF search | [Live block](https://localmode.ai/blocks/knowledge/semantic-search) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/knowledge/semantic-search) |
| Knowledge Base (Semantic Search) | WebGPU batch distance computation for large indexes | [Live block](https://localmode.ai/blocks/knowledge/semantic-search) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/knowledge/semantic-search) |
