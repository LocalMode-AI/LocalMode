...
<Callout type="info" title="See it in action">
  Try the [Knowledge Base block](https://localmode.ai/blocks/knowledge/vector-data-manager) and [Photo Search block](https://localmode.ai/blocks/photo/image-search) for working demos of these APIs.
</Callout>
...
|-----|-------------|-------|
| Knowledge Base (Semantic Search) | Type-safe metadata filtering on vector search results | [Live block](https://localmode.ai/blocks/knowledge/semantic-search) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/knowledge/semantic-search) |
| Photo Search (Product Search) | Typed product metadata for filtered catalog search | [Live block](https://localmode.ai/blocks/photo/image-search) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/photo/image-search) |
