...
<Callout type="info" title="See it in action">
  Try the [Agent & Structured Data block](https://localmode.ai/blocks/agents/data-extractor) for a working demo of these APIs.
</Callout>
...
|-----|-------------|-------|
| Agent & Structured Data (Data Extractor) | Extract structured JSON from unstructured text | [Live block](https://localmode.ai/blocks/agents/data-extractor) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/agents/data-extractor) |
| Agent & Structured Data (Research Agent) | Generate structured tool calls and reasoning steps | [Live block](https://localmode.ai/blocks/agents/research-agent) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/agents/research-agent) |
