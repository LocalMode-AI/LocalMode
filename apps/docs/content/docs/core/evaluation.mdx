...
<Callout type="info" title="See it in action">
  Try the [Model Evaluator block](https://localmode.ai/blocks/text-insights/model-evaluator) for a working demo of these APIs — it scores a classifier in-browser (accuracy/precision/recall/F1 with a color-coded confusion matrix and JSON export).
</Callout>
...
|-----|-------------|-------|
| Text Insights (Model Evaluator) | Evaluate model accuracy, precision, recall, and F1 | [Live block](https://localmode.ai/blocks/text-insights/model-evaluator) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/text-insights/model-evaluator) |
