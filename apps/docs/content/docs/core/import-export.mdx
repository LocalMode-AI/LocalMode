...
<Callout type="info" title="See it in action">
  Try the [Knowledge Base block](https://localmode.ai/blocks/knowledge/vector-data-manager) for a working demo of these APIs — its Data tab runs Pinecone/CSV/JSONL import and export against a live in-browser corpus.
</Callout>
...
|-----|-------------|-------|
| Knowledge Base (Semantic Search) | Export and import vector indexes | [Live block](https://localmode.ai/blocks/knowledge/vector-data-manager) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/knowledge/vector-data-manager) |
| Knowledge Base (Data Migrator) | Migrate vectors between Pinecone, ChromaDB, CSV, JSONL | [Live block](https://localmode.ai/blocks/knowledge/vector-data-manager) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/knowledge/vector-data-manager) |
