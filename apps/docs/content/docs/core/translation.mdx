...
<Callout type="info" title="See it in action">
  Try the [Translator block](https://localmode.ai/blocks/writing-tools/translate) for a working demo of these APIs.
</Callout>
...
<Callout type="info" title="Language detection">
  ...
  the [`@localmode/mediapipe`](/docs/mediapipe) provider. The `SUPPORTED_LANGUAGES`
...
|-----|-------------|-------|
| Writing Tools (Translator) | Translate text between 200+ languages | [Live block](https://localmode.ai/blocks/writing-tools/translate) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/writing-tools/translate) |
| Writing Tools (Smart Writer) | Multi-language writing assistant with translation | [Live block](https://localmode.ai/blocks/writing-tools/write) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/writing-tools/write) |
