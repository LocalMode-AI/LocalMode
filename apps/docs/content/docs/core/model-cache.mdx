...
<Callout type="info" title="See it in action">
  Try the [Knowledge Base block](https://localmode.ai/blocks/knowledge) for a working demo of model caching with progress tracking.
</Callout>
...
|-----|-------------|-------|
| Knowledge Base (PDF Search) | Model preloading with progress UI and cache management | [Live block](https://localmode.ai/blocks/knowledge/semantic-search) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/knowledge/semantic-search) |
