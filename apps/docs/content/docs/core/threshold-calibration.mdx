...
<Callout type="info" title="See it in action">
  Try the [Threshold Calibrator block](https://localmode.ai/blocks/text-insights/threshold-calibrator) and [Photo Search block](https://localmode.ai/blocks/photo/image-search) for working demos of these APIs — the Threshold Calibrator runs `calibrateThreshold()` over a live in-browser corpus, built on the `ui/results/threshold-calibration-panel` primitive.
</Callout>
...
|-----|-------------|-------|
| Text Insights (Threshold Calibrator) | Calibrate similarity thresholds from labeled data | [Live block](https://localmode.ai/blocks/text-insights/threshold-calibrator) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/text-insights/threshold-calibrator) |
| Photo Search (Product Search) | Threshold tuning for product similarity matching | [Live block](https://localmode.ai/blocks/photo/image-search) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/photo/image-search) |
