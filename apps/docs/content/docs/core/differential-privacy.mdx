...
<Callout type="info" title="See it in action">
  Try the [PII Redactor block](https://localmode.ai/blocks/privacy/pii-redactor) for a working demo of these APIs — its differential-privacy demonstration wires `dpEmbeddingMiddleware` and `createPrivacyBudget` live in the browser.
</Callout>
...
|-----|-------------|-------|
| Privacy (PII Redactor) | Apply differential privacy noise to NER + embeddings | [Live block](https://localmode.ai/blocks/privacy/pii-redactor) · [Source](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/ui/src/app/blocks/privacy/pii-redactor) |
