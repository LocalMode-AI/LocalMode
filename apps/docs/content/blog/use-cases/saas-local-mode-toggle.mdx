...
For embeddings and classification, quality is nearly indistinguishable. For LLM generation, local models (1-4B parameters) are noticeably less capable than GPT-5 on complex tasks but adequate for most chat and summarization use cases. Be transparent about the trade-off.
