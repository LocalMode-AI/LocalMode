...
faq:
  ...
  - question: "Do cached AI models survive PWA app updates?"
    answer: "Yes. Models are cached in IndexedDB, which persists across app updates and browser restarts. The only exception is Safari Private Browsing, which clears IndexedDB on close — use MemoryStorage as a fallback."
