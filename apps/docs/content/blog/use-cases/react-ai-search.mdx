...
After model load, embedding a query takes 5-20ms. VectorDB search over 10K vectors takes < 5ms. Total search latency is under 30ms - faster than any network-based search solution.
