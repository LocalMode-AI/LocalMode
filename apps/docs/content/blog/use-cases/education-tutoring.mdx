...
faq:
  - question: "Is on-device AI tutoring COPPA-compliant?"
    answer: "Browser-based processing where no student data is transmitted to servers avoids triggering COPPA's collection provisions. However, consult a compliance attorney for your specific use case, as COPPA compliance involves more than just data processing."
  - question: "How well do small local models perform as tutors?"
    answer: "For explaining established concepts like math rules, vocabulary, and science facts, 1.5B-3B models perform well. For open-ended creative or complex reasoning tasks, quality drops compared to GPT-4. Focus the tutor on structured, known-answer interactions."
  - question: "Can a local AI tutor work offline in schools with poor internet?"
    answer: "Yes. Once the model is downloaded and cached by the browser, the entire tutoring system works without internet. This is ideal for schools with unreliable connectivity or restricted networks."
---
