...
Qwen2.5-1.5B at Q4_K_M is 986MB. For a kiosk or tablet deployment, you can pre-cache this during setup. Smaller options: SmolLM2-135M (70MB) for basic responses, Qwen2.5-0.5B (386MB) for better quality. All cache in IndexedDB permanently.

### Can the chatbot access a knowledge base offline?
