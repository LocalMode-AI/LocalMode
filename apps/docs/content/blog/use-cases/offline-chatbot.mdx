...
faq:
  - question: "How large is the model download for an offline chatbot?"
    answer: "Qwen2.5-1.5B at Q4_K_M is 986MB. Smaller options include SmolLM2-135M (70MB) for basic responses and Qwen2.5-0.5B (386MB) for better quality. All models cache permanently in the browser after download."
