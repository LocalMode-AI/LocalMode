...
faq:
  - question: "Is AI contract analysis admissible in legal proceedings?"
    answer: "LocalMode provides information extraction tools, not legal advice. Extracted entities and classifications should be reviewed by qualified legal professionals. The tool accelerates review but does not replace human judgment."
  - question: "Can LocalMode handle multilingual contracts?"
    answer: "The NER model works best with English text. For multilingual contracts, use paraphrase-multilingual-MiniLM (50+ languages) for semantic search and embeddings. Classification accuracy may vary by language."
  - question: "Does on-device processing protect attorney-client privilege?"
    answer: "On-device processing means contract text never leaves the device, avoiding the risk of transmitting privileged content to third-party cloud services. This architectural guarantee helps maintain confidentiality obligations under ABA Model Rule 1.6."
---
