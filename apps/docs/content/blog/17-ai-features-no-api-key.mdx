...
faq:
  ...
  - question: "How large are the AI models needed for browser-based inference?"
    answer: "Individual models range from 8 MB (photo enhancement) to 284 MB (text summarization). Most apps use 2-4 models totaling 100-500 MB. Models are quantized ONNX weights cached in the browser's Cache API after the first download, so subsequent loads are instant and work offline."
...
This is not a theoretical exercise. Below are 17 features you can ship today, each with a working code snippet using real function signatures from [LocalMode](https://localmode.dev), the model that powers it, and a link to a live demo in the [/blocks gallery](https://localmode.ai/blocks).
...
**Model:** `Xenova/bge-small-en-v1.5` (33 MB) | [Try the live demo](https://localmode.ai/blocks/knowledge/semantic-search)
...
**Model:** `Xenova/distilbert-base-uncased-finetuned-sst-2-english` (67 MB) | [Try the live demo](https://localmode.ai/blocks/text-insights/sentiment-analyzer)
...
**Model:** `Xenova/distilbart-cnn-6-6` (~284 MB quantized) | [Try the live demo](https://localmode.ai/blocks/writing-tools/summarize)
...
**Model:** `Xenova/opus-mt-en-*` (~100 MB per pair) | [Try the live demo](https://localmode.ai/blocks/writing-tools/translate)
...
**Model:** `onnx-community/Florence-2-base-ft` (223 MB) | [Try the live demo](https://localmode.ai/blocks/image-studio/image-captioner)
...
**Model:** `onnx-community/dfine_n_coco-ONNX` (15 MB) | [Try the live demo](https://localmode.ai/blocks/vision/object-detector)
...
**Model:** `Xenova/trocr-small-printed` (~64 MB quantized) | [Try the live demo](https://localmode.ai/blocks/knowledge/semantic-search)
...
**Model:** Pattern-based (0 MB, zero-dependency) + optional NER (108 MB) | [Try the live demo](https://localmode.ai/blocks/privacy/pii-redactor)
...
**Model:** `onnx-community/moonshine-tiny-ONNX` (28 MB) | [Try the live demo](https://localmode.ai/blocks/audio/voice-notes)
...
**Model:** `Xenova/mms-tts-eng` (~38 MB quantized) | [Try the live demo](https://localmode.ai/blocks/audio/audiobook-reader)
...
**Model:** `onnx-community/ModernBERT-base-ONNX` (151 MB) | [Try the live demo](https://localmode.ai/blocks/writing-tools/complete)
...
**Model:** `Xenova/mobilebert-uncased-mnli` (27 MB) | [Try the live demo](https://localmode.ai/blocks/text-insights/text-classifier)
...
**Model:** `Xenova/bert-base-NER` (108 MB) | [Try the live demo](https://localmode.ai/blocks/privacy/pii-redactor)
...
**Model:** `Xenova/distilbert-base-cased-distilled-squad` (~66 MB quantized) | [Try the live demo](https://localmode.ai/blocks/knowledge/document-qa)
...
**Model:** `briaai/RMBG-1.4` (176 MB) | [Try the live demo](https://localmode.ai/blocks/image-studio/background-remover)
...
**Model:** `Xenova/swin2SR-lightweight-x2-64` (~8 MB) | [Try the live demo](https://localmode.ai/blocks/image-studio/image-enhancer)
...
**Model:** `Xenova/clip-vit-base-patch32` (~154 MB quantized) | [Try the live demo](https://localmode.ai/blocks/photo/image-search)
...
Total size if you use every feature: under 2 GB quantized. In practice, most apps use 2-4 models that together weigh 100-500 MB, cached in the browser's Cache API after the first download, and available offline forever.
...
Models are downloaded from HuggingFace Hub on first use and cached in the browser's Cache API. Subsequent loads are instant and work fully offline.
...
<Callout type="info" title="Try it yourself">
  Visit the [/blocks gallery](https://localmode.ai/blocks) to try LocalMode's AI features as installable blocks running entirely in your browser. No sign-up, no API keys, no data leaves your device.
