...
| 3 | Text Summarization | `summarize()` | `Xenova/distilbart-cnn-6-6` | ~284 MB | ~85% of GPT-4o (ROUGE-2: 20.17) |
| 4 | Language Translation | `translate()` | `Xenova/opus-mt-en-*` | ~100 MB per pair | ~85% of Google Translate (BLEU) |
| 5 | Image Captioning | `captionImage()` | `onnx-community/Florence-2-base-ft` | 223 MB | 60-70% of GPT-4o |
...
| 12 | Email Classification | `classifyZeroShot()` | `Xenova/mobilebert-uncased-mnli` | 27 MB | 94-97% of GPT-4o (MNLI) |
| 13 | Named Entity Recognition | `extractEntities()` | `Xenova/bert-base-NER` | 108 MB | 95-98% of GPT-4o |
| 14 | Question Answering | `answerQuestion()` | `Xenova/distilbert-base-cased-distilled-squad` | ~66 MB | 92-95% of GPT-4o (SQuAD F1) |
