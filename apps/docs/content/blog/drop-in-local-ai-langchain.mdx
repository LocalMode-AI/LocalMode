...
faq:
  ...
  - question: "What models are recommended for a local LangChain.js RAG pipeline?"
    answer: "BGE-small-en-v1.5 (33 MB, 384 dimensions) for embeddings via @localmode/transformers, and Qwen3 1.7B (~1.1 GB) for chat via @localmode/webllm. The LangChain RAG showcase app at localmode.ai/langchain-rag demonstrates this exact combination with document ingestion and source-cited answers."
---
...
- [LangChain RAG showcase app](https://github.com/LocalMode-AI/LocalMode/tree/main/apps/showcase-nextjs/src/app/%28apps%29/langchain-rag) - full working demo
