...
| LLM knowledge (Qwen3.5-4B, thinking) | **~96%** of GPT-5 | MMLU-Redux 88.8% vs MMLU 92.5% |
...
*Note: MMLU and MMLU-Redux are related but distinct benchmarks. MMLU-Redux corrects labeling errors in the original MMLU. GPT-5 scores 92.5% on MMLU, making Qwen3.5-4B's 88.8% MMLU-Redux a strong but not quite matching result. The comparison shows local models closing in on frontier quality.
