...
faq:
  ...
  - question: "What are the trade-offs of using local AI tools compared to cloud services for content creation?"
    answer: "Local tools offer one voice for TTS versus dozens from ElevenLabs, slightly lower translation quality on idiomatic expressions, one-at-a-time browser processing versus bulk API queues, and slower performance on older devices. For mainstream content creation workflows with clear prose, these trade-offs are generally acceptable."
---
...
| Step | Tool | Model | Download (one-time) | Time | Output |
|------|------|-------|---------------------|------|--------|
| Generate speech | [Audiobook Creator](https://localmode.ai/audiobook-creator) | MMS-TTS | ~38MB | 5–15 sec per 5K chars | WAV audio |
