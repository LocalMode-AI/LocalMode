...
| bert-base-NER | ~110MB | NER | CoNLL-2003 F1 | 91.3% | **95-98%** of GPT-4o | ~10s |
...
- [dslim/bert-base-NER model card](https://huggingface.co/dslim/bert-base-NER) -- CoNLL-2003 test F1 91.3%
