...
Most of the LocalMode examples you see online are written in React. That is because the showcase app at [localmode.ai](https://localmode.ai) is a Next.js application, and because `@localmode/react` ships 56 purpose-built hooks that make React integration especially smooth.
...
| `@localmode/react` | React hooks (56 hooks) | **Yes** | No | No | No | No |
