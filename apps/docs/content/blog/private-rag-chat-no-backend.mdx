...
Now feed the retrieved context to a language model running entirely in the browser. LocalMode supports four LLM providers - all using the same `streamText` function:
