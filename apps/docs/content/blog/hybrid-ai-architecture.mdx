...
faq:
  ...
  - question: "What percentage of AI requests can local browser models handle?"
    answer: "Analysis of 20+ showcase applications shows approximately 95% of AI calls fall into categories where local models deliver 90-99% of cloud quality. These include embeddings (99% of OpenAI), classification (93%+), NER (93-96%), and reranking (87-93%)."
