...
faq:
  ...
  - question: "What are the peer dependencies for @localmode/ai-sdk?"
    answer: "The adapter requires ai (>=6.0.0), @ai-sdk/provider (>=1.0.0), @ai-sdk/provider-utils (>=3.0.0), and @localmode/core (>=1.0.0). You also need at least one LocalMode model provider such as @localmode/webllm for LLMs or @localmode/transformers for embeddings."
---
