...
faq:
  ...
  - question: "Can I run Phi models offline?"
    answer: "Yes. All Phi variants work offline after the initial download (1.2-2.4GB depending on variant). Models are cached by the browser and require no API keys or network connection for inference."
---
