...
faq:
  ...
  - question: "Can I run Gemma offline after downloading?"
    answer: "Yes. All Gemma variants work offline after the initial download. Models are cached in IndexedDB via LocalMode's model caching system, and subsequent uses require no network connection."
