...
faq:
  ...
  - question: "Can I run BGE embeddings offline?"
    answer: "Yes. After the initial model download (33MB or 110MB), BGE models are cached in IndexedDB and work entirely offline. No network connection is needed for subsequent use."
---
