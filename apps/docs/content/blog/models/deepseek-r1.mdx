...
faq:
  ...
  - question: "Can I run DeepSeek-R1 offline in the browser?"
    answer: "Yes. All DeepSeek-R1 variants work offline after the initial download. Models are cached in IndexedDB via LocalMode's model caching system, so subsequent uses start without any network connection."
---
