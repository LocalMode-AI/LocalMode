...
# The whole local-first family (25 primitives)
...
- `apps/ui/registry/localmode/local-first/**` (incl. `local-first/device-badge/device-badge.tsx`) — component source and props
