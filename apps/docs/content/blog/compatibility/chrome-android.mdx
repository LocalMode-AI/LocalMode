...
faq:
  ...
  - question: "How much storage does model caching require on Chrome Android?"
    answer: "Storage depends on the models you download. Chrome grants up to 60% of total disk size per origin for IndexedDB. Recommended Android models range from about 33MB (BGE-small embeddings) to 360MB (SmolLM2-360M). Use getStorageQuota() to check available space before downloading."
