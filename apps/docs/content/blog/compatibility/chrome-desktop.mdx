...
description: "Full LocalMode support on Chrome Desktop - WebGPU, WASM, IndexedDB, Web Workers, and all 135 curated models."
author: "LocalMode"
date: "2026-04-11"
...
faq:
  ...
  - question: "How much storage does model caching require on Chrome Desktop?"
    answer: "Chrome grants up to 60% of total disk size per origin for browser storage. Model sizes vary from about 33MB for embeddings (BGE-small) to several gigabytes for larger LLMs. Use navigator.storage.persist() to prevent Chrome from evicting cached models under storage pressure."
...
Full LocalMode support on Chrome Desktop - WebGPU, WASM, IndexedDB, Web Workers, and all 135 curated models.
...
- **Chrome Built-in AI** - Your app ships no model files; Chrome downloads the model once, browser-wide, on first use. Requires Chrome 138+ on desktop, no flag. Provides summarization, translation, and writing assistance via Gemini Nano.
