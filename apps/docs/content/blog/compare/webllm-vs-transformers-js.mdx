...
faq:
  ...
  - question: "How stable is Transformers.js v4 for LLM inference?"
    answer: "Transformers.js v4 is stable and production-ready. LocalMode uses @huggingface/transformers ^4.2.0, and the 16 curated ONNX LLM models have been browser-tested. The same LanguageModel interface works across WebLLM, wllama, and Transformers.js."
