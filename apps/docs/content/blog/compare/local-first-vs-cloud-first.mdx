...
- [OpenAI API pricing page](https://openai.com/api/pricing/) - `text-embedding-3-small` at $0.02/M tokens (standard), $0.01/M (batch); `GPT-4o` at $2.50/M input tokens, $10.00/M output tokens (as of May 2026)
