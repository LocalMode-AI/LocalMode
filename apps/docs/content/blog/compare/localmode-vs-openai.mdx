...
faq:
  ...
  - question: "What about the initial model download time?"
    answer: "Models download once and are cached in IndexedDB. BGE-small (33MB) downloads in 2-5 seconds on a typical connection. LLMs (1-4GB) take 30-120 seconds. After caching, models load from local storage in under a second. Use preloadModel() to download during onboarding or idle time."
