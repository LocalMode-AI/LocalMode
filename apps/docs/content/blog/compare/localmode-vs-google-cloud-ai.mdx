...
faq:
  - question: "Is LocalMode accuracy good enough to replace Google Cloud Vision?"
    answer: "For the 80 COCO object categories and 1000 ImageNet classes, quality is comparable. For specialized domains like medical imaging, satellite imagery, or handwriting, Google Cloud has significantly more training data and higher accuracy."
  - question: "What about Google Gemini Nano in Chrome?"
    answer: "LocalMode's @localmode/chrome-ai package wraps Chrome's built-in Gemini Nano for summarization, translation, and text generation with zero download. It requires Chrome 138+ (Prompt API stable since Chrome 148), 22 GB free disk space, and 4 GB+ GPU VRAM or 16 GB+ RAM."
  - question: "How much does Google Cloud AI cost for a typical document processing app?"
    answer: "A document processing app handling 10,000 pages/month costs roughly $29/month with Google Cloud (OCR + Vision + Translation). The same app with LocalMode costs $0/month, since model downloads are one-time and free."
---
