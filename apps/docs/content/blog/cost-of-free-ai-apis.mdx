...
OpenAI's pricing has dropped dramatically since GPT-4's launch. The original GPT-4 cost $30 per million input tokens and $60 per million output tokens in May 2023. GPT-4o launched in May 2024 at $5/$15, then dropped to $2.50/$10 -- a cumulative reduction of over 90% on input tokens ([OpenAI Pricing](https://openai.com/api/pricing/), [Nebuly GPT-4 Pricing History](https://web.archive.org/web/20250119175245/https://www.nebuly.com/blog/openai-gpt-4-api-pricing)).
...
- [OpenAI API Pricing](https://openai.com/api/pricing/) -- GPT-4o ($2.50/$10.00 per 1M input/output tokens), text-embedding-3-small ($0.02/1M tokens), Whisper ($0.006/min); verified May 2026. GPT-4o launched at $5/$15 in May 2024, reduced to $2.50/$10 in August 2024 with the gpt-4o-2024-08-06 model version.
