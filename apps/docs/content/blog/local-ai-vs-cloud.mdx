...
faq:
  ...
  - question: "What local LLM providers does LocalMode support for browser inference?"
    answer: "LocalMode ships four LLM providers: WebLLM (MLC/WebGPU, fastest), Transformers.js v4 (ONNX/WebGPU, broadest model selection), wllama (GGUF/WASM, universal browser support), and LiteRT-LM (Google's on-device engine). Together they offer 76 curated models and access to 160,000+ GGUF models."
---
...
LocalMode now ships **four LLM providers** that run entirely in the browser - WebLLM (MLC/WebGPU, fastest), Transformers.js v4 (ONNX/WebGPU, broadest model selection), wllama (GGUF/WASM, universal browser support), and LiteRT-LM (Google's on-device engine, early preview). Together they offer 76 curated models and access to 160,000+ GGUF models on HuggingFace.
