...
**NER**: `bert-base-NER` achieves **91.3% F1** on the CoNLL-2003 test set. GPT-5 achieves approximately 95-98% with careful prompting. The local model reaches 93-96% of cloud quality at 30-100ms latency (vs. 500-3000ms for GPT-5).
