...
| DeepSeek-R1-Distill-Qwen-7B-q4f16_1-MLC | WebLLM (WebGPU) | 4.2GB | Slow | High |
| DeepSeek-R1-Distill-Llama-8B-q4f16_1-MLC | WebLLM (WebGPU) | 4.4GB | Slow | High |
...
- [OpenAI API pricing - GPT-4o](https://openai.com/api/pricing/)
