...
- **Chrome Built-in AI** - Chrome Built-in AI (Gemini Nano). Your app ships no model files; Chrome fetches the model once, browser-wide. Available in Chrome 138+ on desktop, no flag.
